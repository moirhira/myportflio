...
export default function About() {
  return (
    <section id="about" className="about bg-[color:var(--darker-bg)] text-center py-20">
      <div className="mx-auto w-11/12 max-w-1600 px-5">
        <h2 className="gradient-heading text-3xl mb-6">About</h2>
        <p className="mx-auto max-w-3xl mb-8 leading-relaxed opacity-90 tracking-wide">
        ...
        <h3 className="gradient-heading text-2xl mb-6">Skills</h3>
